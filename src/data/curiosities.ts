...
It is not a chatbot on top of a database. That distinction matters.`,
  ...
  },
  {
    ...
    year: '2025',
    status: 'ACTIVE',
    description: `One of the underrated problems in large organizations is that no one has a real-time picture of their entire project portfolio. The data exists — budgets, schedules, milestones, risk registers — but it's fragmented across systems, formats, and teams.
